                      ...
                      "
                                        >
                                            <div className="flex justify-center items-center h-full">
                                                {/* FaCheck -> Font Awesome */}
                                                <i
                                                    className="
                            fa-solid fa-check text-[#DDE4FF]
                        ...
                        "
                          ...
                          "
                            ...
                            "
                              ...
                              "
                                ...
                                "
                                                        ...
                                                        <div className="w-[6px] h-[3px] bg-black" />
                            ...
                            "
                              ...
                              "
                                                        >
                                                            <div className="w-[26px] h-[7px] sm:w-[32px] sm:h-[8px] md:w-[40px] md:h-[10px] bg-white rounded-full mx-auto" />
                                                            <div className="w-[32px] h-[4px] sm:w-[38px] sm:h-[5px] md:w-[45px] md:h-[6px] bg-red-400 rounded-b-full mt-[4px] mx-auto" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
