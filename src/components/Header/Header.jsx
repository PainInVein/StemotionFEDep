            ...
            <div className="hidden md:flex items-center gap-2">
              {isAuthenticated ? (
                <>
                  ...
                  >
                    <i
                      className="fa-regular fa-circle-user text-[22px]"
                      aria-hidden="true"
                    />
            ...
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-2 leading-relaxed">
                  Tài khoản phụ huynh của bạn hiện chưa nâng cấp Premium. Nếu
                  muốn học sinh có thể học thêm và mở khóa toàn bộ nội dung, vui
                  lòng nâng cấp gói Premium.
                </p>
              </div>
