...
export default function Footer() {
  ...
  const iconBase =
    "text-2xl text-gray-400 hover:text-white transition-transform hover:scale-110";
    ...
    <footer className="bg-black text-white py-12 md:py-20 px-6 md:px-20 font-sans">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-5 gap-10 md:gap-12 mb-16 items-start">
          <div className="sm:col-span-3 md:col-span-2">
            ...
            <p className="text-gray-400 text-base md:text-lg leading-relaxed max-w-sm">
              Mang đến trải nghiệm học Toán tương tác giúp học sinh tiểu học vừa
              học, vừa chơi và khám phá kiến thức một cách tự nhiên.
            </p>
          </div>

          <div className="md:pt-2">
            <h3 className="text-gray-500 text-xs md:text-sm font-semibold mb-5 uppercase tracking-wider">
              Về ứng dụng
            </h3>
          ...
          {/* Social icons */}
          <div className="flex space-x-6 md:pt-1 md:justify-end">
            <a
              href="https://www.facebook.com/profile.php?id=61584193513025"
              className={iconBase}
              aria-label="Facebook"
              target="_blank"
              rel="noreferrer"
        ...
        <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8 text-xs text-gray-500 border-t border-gray-800 pt-8">
          ...
          <a href="#" className="hover:text-gray-300">
            Không bán thông tin cá nhân của người dùng
          </a>
