          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
            ...
            <div className="space-y-6">
              ...
              <div className="relative">
                <div className="bg-gradient-to-r from-[#FF9FB2] via-[#B2A5FF] to-[#FFD09B] p-1 rounded-[22px] shadow-lg">
                  <div className="bg-[#F5F5F8] rounded-[20px] p-6 md:p-8">
                    {/* Large day number */}
                    <div className="mb-8">
              ...
              <div className="bg-gradient-to-r from-[#FF9FB2] via-[#B2A5FF] to-[#FFD09B] p-1 rounded-[22px] shadow-lg">
                <div className="bg-[#F5F5F8] rounded-[20px] p-6 md:p-8">
                  <div className="flex items-center justify-center mb-6">
                    ...
                    <h2 className="text-2xl md:text-[32px] font-bold text-indigo-400 font-brilliant leading-tight">
                      Bảng xếp hạng
                    </h2>
                  </div>
              ...
              <div className="relative">
                ...
                <div className="relative bg-[#F8F8F8] border-4 border-brand-purple rounded-[15px] p-6 md:p-8 min-h-[500px] md:min-h-[651px] flex flex-col">
                  ...
                  <div className="flex justify-center mb-6 md:mb-8">
                    <div className="bg-indigo-400 backdrop-blur-sm text-white font-bold text-sm md:text-base px-6 md:px-8 py-2 rounded-[22px] font-brilliant">
                      BÀI HỌC ĐỀ XUẤT
                    </div>
                  </div>
